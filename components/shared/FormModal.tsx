...
interface FormModalProps<T extends { id: number }, D> {
  ...
  renderForm: (formData: D, errors: Record<string, string>, onChange: (field: keyof D | React.ChangeEvent<HTMLInputElement | HTMLSelectElement>, value?: unknown) => void) => ReactNode;
